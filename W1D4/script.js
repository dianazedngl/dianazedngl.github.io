...
function masterFunction() {
    ...
    //5. reverse string
    document.getElementById("rev1").innerHTML= "Expected output of reverse(\"for test\") is tset rof ... " + testFunction("tset rof",reverse("for test"));
    ...
    var words=["Hi","goodmorning","student"];
    var words1=["how", "are","you","today"];
    document.getElementById("long1").innerHTML= "Expected output of findLongestWord([\"Hi\", \"goodmorning\", \"student\"]) is 11 ... " + testFunction(11,findLongestWord(words));
...
function isVowel(str) {
    var vowel="EeUuIiAaOo";
    return (vowel.indexOf(str) >= 0);
}
